...
const Header = () => {
  ...
  return (
    <div className="header md:bg-white md:z-50 md:fixed md:w-10/12 xl:w-[1450px] md:h-[62px] md:flex justify-between md:border-b border-grey items-center md:px-6 px-3 max-sm:pt-3 xl:-ml-[3.5%]">
